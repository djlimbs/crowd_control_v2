Ember.TEMPLATES["djSuggestions"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(">Just Nays</a></li>\n		  	</ul>\n		</div>\n		<button type=\"button\" class=\"btn btn-default\">Print</button>\n	</div>\n	<h3 class=\"pb0\">Check out some suggestions from your DJ</h3>\n	<p>Here are some songs your DJ thought might fit your vibe, feedback encouraged\n</div>");
  return buffer;
...
function program4(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "categoryName", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</h4>\n				<p><small><i class=\"text-muted\">");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "categoryDescription", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "clickShowNays", {hash:{},contexts:[depth0],types:["STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push(">Just Nays</a></li>\n		  	</ul>\n		</div>\n		<button type=\"button\" class=\"btn btn-default\">Print</button>\n	</div>\n	<h3 class=\"pb0\">See what your guests picked</h3>\n	<p>Here's a list of what your guests requested, thumbs up or veto them\n</div>");
  return buffer;
...
function program5(depth0,data) {
  ...
  data.buffer.push("<a href=\"#\">DJ Suggestions</a>");
  }
  ...
  stack2 = ((stack1 = helpers['link-to'] || (depth0 && depth0['link-to'])),stack1 ? stack1.call(depth0, "djSuggestions", options) : helperMissing.call(depth0, "link-to", "djSuggestions", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n	    </ul>\n	</div>\n	");
  hashTypes = {};
  hashContexts = {};
